...
import { BaseEntity, BaseState, CrudService, withCrudOperations } from './03-feature';
...
@Component({
    ...
    imports: [JsonPipe],
    template: `
        <h1>03 Stream Work in Progress Conditional Feature</h1>
        <p>hey</p>
